...
feature "Viewing comments" do
  ...
  let! (:post_1) { FactoryGirl.create(:post, title: "The postest with the mostest", content: "More is less and less is more", author: "Sally")}
  let! (:comment1) {FactoryGirl.create(:comment, post: post_1, content: "I couldn't agree more.", author: "Tasha")  }
